Feature: Add new address to ready user profile
  ...
  Scenario Outline: Log in to user account on https://mystore-testlab.coderslab.pl/
    ...
    Then Added address information should be <alias>, <address>, <city>, <postal code>, <phone> and sees message confirmed
    ...
    Examples:
      ...
      | Mr    | Lubuska 45/678    | 52-001      | Kielce   | 987 654 321 |
      | Mr    | Warszawska 90/999 | 00-110      | Gliwice  | 543 129 678 |